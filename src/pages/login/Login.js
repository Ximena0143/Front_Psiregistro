        ...
        if (error.status) {
          switch (error.status) {
            ...
            case 500:
              ...
              errorMsg =
                "Hay un problema en el servidor. Por favor, intenta nuevamente o contacta al administrador.";
              break;
            default:
          ...
          errorMsg =
            "No se pudo completar la autenticación. Contacta al administrador del sistema.";
        }
